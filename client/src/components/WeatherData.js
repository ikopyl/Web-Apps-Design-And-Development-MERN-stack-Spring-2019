  ...
  render() {
    return (
      <div className="container ui grid">
        <form
          className="eight wide column row"
        ...
        <div className="row">
          <div className="ui card">
            <div className="image">
              <img
                src={this.props.weather_icon_source}
            ...
            <div className="content">
              <div>
                <span className="ui sub header">
                  Humidity{' '}
                  {this.props.weatherData.consolidated_weather[0].humidity}%
                </span>
              </div>
              <div>
                <span className="ui sub header">
              ...
              <div>
                <span className="ui sub header">
                  Wind Direction{' '}
                  {
                    this.props.weatherData.consolidated_weather[0]
              ...
              <div>
                <span className="ui sub header">
                  Wind Speed{' '}
                  {this.props.weatherData.consolidated_weather[0].wind_speed}{' '}
                  &nbsp; km
                </span>
              </div>
              <div>
                <span className="ui sub header">
                  {this.props.searchCity} &nbsp; {this.props.searchState}
                </span>
              </div>
            </div>
          </div>
